def get_values(*names):
            ...
            _all_values = json.loads("""
                                     ...
                                     "mount_side":"right",
                                     "tip_type":"standard",
                                     "trough_type":"nest_12_reservoir_15ml",
                                     "plate_type":"nest_96_wellplate_200ul_flat",

                                     "dilution_factor":3,"num_of_dilutions":3,
                                     "total_mixing_volume":100,"blank_on":true,
                                     "tip_use_strategy":"never","air_gap_volume":10,
                                     "protocol_filename":"customizable_serial_dilution_ot2"
                                     }""")
